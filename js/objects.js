...
var allArticles = [
{
	...
	img : "http://content.onliner.by/news/2014/09/large/4c9bd5c289b0e3ac4d509ff0f0920b12.jpg",
	author : "БЕЛТА",
	topic : "Sport",
...
{
	title : "СМИ: LG хочет сократить ассортимент смартфонов",
	img : "http://content.onliner.by/news/2014/12/default/eb8126ddd599af0484224516a6183ee5.jpg",
	author : "Ян Альшевский",
	topic : "Tech",
	date : new Date("12/10/2014"),
	stringDate : '10.12.2014',
	text: "По неофициальным данным, компания LG планирует отказаться от устройств линейки G Pro, сосредоточив усилия на будущем LG G4. Первое устройства серии G Pro появилось несколько лет назад: компания предприняла попытку занять место на рынке «планшетофонов». Однако тот же LG G3, например, имеет 5,5-дюймовый дисплей, поэтому особой необходимости в новых LG G Pro больше нет, предполагают в Phandroid. В случае появления единственного флагмана его можно будет снабдить лучшим набором комплектующих. При этом не придется опасаться того, что еще один топовый аппарат (но другой линейки) переманит потенциальных покупателей. Кроме того, выгоднее продвигать единственный топовый гаджет, нежели несколько подобных. Стоит отметить, что аналогичную стратегию выбрали Sony и Samsung, готовые сократить ассортимент мобильных устройств ради повышения эффективности бизнеса. Также интриги добавляет зарегистрированная LG торговая марка G Pen. Сфера ее применения остается неясной, так как в описании упоминается практически все, что так или иначе связано с электроникой. Аналогично обстоит ситуация с торговым знаком G Scrawl: о нем ничего не известно, но предполагается, что это графическое приложение для работы с G Pen."
},

{
	title : "Microsoft подает в суд на пользователя, который слишком часто активировал пиратскую Windows",
	img : "http://content.onliner.by/news/2014/12/default/83d3b9af2736a2fcf592e3ec1137030c.jpg",
	author : "Ян Альшевский",
	topic : "Tech",
	date : new Date("12/1/2014"),
	stringDate : '1.12.2014',
	text: "Корпорация Microsoft, чьи продукты причисляют к наиболее популярным среди компьютерных пиратов, нечасто ведет преследование частных лиц, использующих контрафактное ПО. Ранее глава компании Сатья Наделла даже заявил, что пираты при определенных обстоятельствах могут стать пользователями лицензионного программного обеспечения. В рамках подобного подхода Microsoft регулярно проводит кампании, призванные косвенно бороться с пиратством. Так, в 2012 году сразу после релиза Windows 8 софтверный гигант предложил значительную скидку на ОС в сотне стран. Тогда Беларусь в отличие, например, от Гондураса не попала в список, где действовала эта программа, и с тех пор ситуация практически не изменилась. Вероятно, в Microsoft все же решили предпринять более активные шаги по борьбе против нечестных пользователей. Как сообщает TorrentFreak, корпорация оформила иск против абонента (или абонентов) американского провайдера AT&T. Специалисты компании определили, что с определенного IP-адреса было проведено значительное количество активаций Windows 7 и Microsoft Office 10. Многие пользователи, предпочитающие пиратское ПО, считают, что вычислить их сложно, однако, утверждают в Microsoft, в реальности это не так. В настоящее время компания проводит мероприятия по идентификации пользователя, скрывающегося за IP-адресом 76.245.7.147, чтобы тот ответил по закону."
},
...
{
	title : "Samsung начала продажи шлема виртуальной реальности",
	img : "http://content.onliner.by/news/2014/12/default/32e993f26bf0297bf238b66281388789.jpg",
	author : "Ян Альшевский",
	topic : "Tech",
	date : new Date("12/5/2014"),
	stringDate : '5.12.2014',
	text: "Компания Samsung накануне начала продажи шлема виртуальной реальности Gear VR Innovator Edition, который стал доступен покупателям в США. Для работы гаджета потребуется Galaxy Note 4, устанавливаемый в специальный отсек. Обойдется Gear VR в $200, еще $50 стоит беспроводной игровой контроллер Samsung. Пока неизвестно, намерена ли компания реализовать поддержку других мобильных устройств. Владельцы Innovator Edition получат доступ к комплекту средств разработки Oculus Mobile SDK, который включает Oculus Home, Store, Cinema и другие интерфейсы. Разработка Gear VR велась совместно с компанией Oculus, поэтому девайс получил некоторые комплектующие от первой модели Oculus Rift. Как отмечает The Verge, приставка Innovator Edition в названии Gear VR косвенно указывает на то, что устройство пока находится в состоянии «бета» со всеми последствиями. Сейчас шлем виртуальной реальности Samsung является наиболее доступным из аналогов. Кроме того, в отличие от Oculus Rift шлем корейской компании намного более мобилен, так как не требует подключения к компьютеру и не имеет проводов."
},
{
